...
const translations = {
  ...
  de: {
    ...
    subtitle:
      "Finden Sie den perfekten Kurs für Ihren Angelschein in Deutschland",
...
export default function CoursesPage() {
  ...
  //       locationFilter === "all" || course.location === locationFilter;
  //
  ...
  //   searchQuery || levelFilter !== "all" || locationFilter !== "all";

  return (
    <div className="min-h-screen">
      {/* Hero Banner */}
      <div className="relative bg-[var(--color-primary-dark)] py-16 md:pt-52 md:pb-24">
        <div className="absolute inset-0 opacity-20">
          <div
            className="w-full h-full bg-cover bg-center"
            style={{
              backgroundImage:
                "url(https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1920&h=400&fit=crop)",
            }}
          />
        </div>
      ...
      <div className="container pt-20">
        ...
        <div className={"mb-12"}>
          <h2 className={"text-4xl text-center"}>All Courses</h2>
        </div>
        ...
        {courses.length > 0 ? (
          <div className="space-y-8">
            ...
            {courses.length > 0 && <CourseCard course={courses[0]} featured />}
